...
[See all defaults](https://github.com/hazzuk/karo-custom/blob/main/karo-compose/defaults/main/hazzuk_media/seerr.yml){:target='_blank'}

??? abstract "Seerr - Media discovery and requests manager"
